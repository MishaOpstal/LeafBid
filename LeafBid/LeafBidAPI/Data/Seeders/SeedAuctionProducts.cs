...
public class SeedAuctionProducts
{
    public static async Task SeedAuctionProductsAsync(ApplicationDbContext context, CancellationToken cancellationToken)
    {
        ...
        await SeedAuctionProductAsync(context, auctioneerId, ClockLocationEnum.Naaldwijk, "TestProduct1", 10, 20, cancellationToken);
        await SeedAuctionProductAsync(context, auctioneerId, ClockLocationEnum.Naaldwijk, "TestProduct2", 9, 100, cancellationToken);
        await SeedAuctionProductAsync(context, auctioneerId, ClockLocationEnum.Aalsmeer, "TestProduct3", 10, 25, cancellationToken);
        await SeedAuctionProductAsync(context, auctioneerId, ClockLocationEnum.Aalsmeer, "TestProduct4", 9, 10, cancellationToken);
    }
